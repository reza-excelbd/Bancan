...
export default function Home() {
  return (
    <div className="">
      {/* Background wrapper for all content sections */}
      <Background>
        ...
        <main className="bg-transparent z-10 h-auto sm:h-[50%] md:h-[55%] lg:h-[60%] relative">
          <CountryCategory />
        </main>

        {/* Category section rendered after everything else in normal flow */}
        <Category className="w-full bg-transparent px-4 sm:px-8 md:px-10 lg:px-14 relative z-10" />
        <HappyHours />
        <SignatureFoods className="bg-transparent" />
        <TasteFood className="bg-transparent" />
        <Contact className="bg-transparent" />
